...
#ifdef DEBUG
_msg = format ["RecoilRedux Call: Medic=%1 | Patient=%2", name _medic, name _patient];
LOG(_msg)
#endif

["bax_drugs_recoilRedux_fnc_recoilBoostLocal", [_patient], _patient] call CBA_fnc_targetEvent;
["bax_drugs_experiphrine_fnc_addExperiphrine", [_patient,_bodyPart,round bax_drugs_recoilredux_dosage], _patient] call CBA_fnc_targetEvent;